...
namespace CASample.Application.IntegrationTests
{
    [SetUpFixture]
    public class Testing
    {
        ...
        public async Task RunBeforeAnyTestsAsync()
        {
            ...
            services.AddSingleton(Mock.Of<IWebHostEnvironment>(w =>
                ...
                w.ApplicationName == "CASample.Api"));
        ...
        private static async Task<string> RunAsUserAsync(string userName, string password, string[] roles)
        {
            ...
            var userManager = scope.ServiceProvider.GetService<UserManager<CASample.Infrastructure.Identity.ApplicationUser>>();

            var user = new CASample.Infrastructure.Identity.ApplicationUser { UserName = userName, Email = userName };
